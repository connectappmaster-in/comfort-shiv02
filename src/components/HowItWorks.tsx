...
const HowItWorks = () => {
  ...
  return (
    <section className="py-[50px] bg-muted/50" aria-labelledby="how-it-works-heading">
      <div className="container mx-auto px-4">
              ...
              {steps.map((step, index) => (
                ...
                >
                  <div className="flex justify-center mb-4">
                    <motion.div 
                      className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-lg font-bold shadow-lg relative z-10"
        ...
        <div className="md:hidden max-w-xs mx-auto">
          <div className="relative">
            <div className="absolute left-5 top-0 bottom-0 w-1 bg-primary rounded-full" />
            ...
            <div className="space-y-4">
              {steps.map((step, index) => (
                ...
                >
                  <div 
                    className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-base font-bold shadow-lg flex-shrink-0 relative z-10"
                    aria-label={`Step ${step.num}`}
                  >
                    {step.num}
                  </div>
